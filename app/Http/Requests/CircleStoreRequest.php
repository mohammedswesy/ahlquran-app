...
class CircleStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // عدّل القيم حسب enum عندك (hifz/tajweed/arabic مثلاً)
            'type'         => ['required', 'string', Rule::in(['hifz','tajweed','arabic'])],
    ...
    public function messages(): array
    {
        return [
            ...
            'institute_id.required' => 'رقم المعهد مطلوب.',
            'institute_id.exists'   => 'المعهد غير موجود.',
            'type.required'         => 'نوع الحلقة مطلوب.',
